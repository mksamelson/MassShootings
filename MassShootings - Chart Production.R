#Mass Shootings - the Mother Jones Magazine Data
#by:  Matt Samelson mksamelson@gmail.com

#This file loads the data and produces various charts
#used in the presentation using ggplot2 library.  It also
#creates the Mosaic plot and performs the Chi Squared test
#used to determine if perpetrator race/age is left to chance or
#if indeed one race/age group tends to perpetrate events.
...
#Print out various information on the dataset
